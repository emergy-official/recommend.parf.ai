# Recommend.parf.ai - Inference code
...
# Build the image
docker build --platform linux/amd64 -t recommend-inference-api:$IMG_VERSION .

# Tag the image so you can push it to AWS ECR (private repo)
docker tag recommend-inference-api:$IMG_VERSION "$ACCOUNT_ID".dkr.ecr.us-east-1.amazonaws.com/recommend-inference-api:latest
